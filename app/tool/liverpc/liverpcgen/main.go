...
func actionGenerate(ctx *cli.Context) (err error) {
	...
	ap("// If you want to change this file, Please see README in github.com/namelessup/bilibili/app/tool/liverpc/protoc-gen-liverpc/")
	ap("package " + clientPkg)
	ap("")
	ap("import (")
	ap(`	"github.com/namelessup/bilibili/library/net/rpc/liverpc"`)
