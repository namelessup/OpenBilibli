...
const (
	bmPkgPath = "github.com/namelessup/bilibili/library/net/http/blademaster"
)
...
func (b *BMGenerate) generatePackageImport() {
	b.P("// Package ", b.packageName, " Code generated by github.com/namelessup/bilibili/app/tool/protoc-gen-bm. DO NOT EDIT.")
	...
	if b.jsonpb {
		...
		b.P("	\"encoding/json\"")
		b.P()
		b.P("	\"github.com/namelessup/bilibili/app/tool/protoc-gen-bm/jsonpb\"")
	}
	b.P()
	b.P("	bm \"", bmPkgPath, "\"")
	b.P(")")
